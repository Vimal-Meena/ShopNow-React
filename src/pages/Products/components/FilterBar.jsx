...
export const FilterBar = ({ setShow }) => {
  ...
  return (
    <section className='filter w-1/12'>
      <div
        id='drawer-disable-body-scrolling'
        className={`fixed left-0 top-15 p-5 z-40 h-max overflow-y-auto bg-white w-50 dark:bg-gray-800 transition-transhtmlForm transhtmlForm-none`}
        tabIndex='-1'
